{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "1111d60b-0329-42f9-b3c8-a6c4a1dacb15",
          "type": "basic.input",
          "data": {
            "name": "clk",
            "pins": [
        ...
        {
          "id": "a0876153-1c32-4484-b507-79b97128f7fb",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "b5ccfd48-59dc-46af-aa4b-963e2525d735",
          "type": "basic.input",
          "data": {
            "name": "ADDR",
            "pins": [
        ...
        {
          "id": "d2bfe48c-792f-4fba-9ddd-930c19af65e1",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "59689380-b6ee-4dae-a8e7-2ba96ab782ff",
          "type": "basic.input",
          "data": {
            "name": "Button",
            "pins": [
        ...
        {
          "id": "86657aff-af94-4d1b-a028-2be7ae639e41",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "8ebea4f5-657d-40d2-ab8a-80c5cc4866dd",
          "type": "basic.input",
          "data": {
            "name": "SWITCH",
            "pins": [
        ...
        {
          "id": "7d1409f4-62e0-4660-9abf-e72268c05744",
        ...
        {
          "id": "48d78d80-f30b-4181-b743-f202982bfb44",
          "type": "basic.code",
          "data": {
        ...
        {
          "id": "2da9cb5c-d663-4c46-9619-bd2ce3f9dfab",
      ...
      "wires": [
        {
          "source": {
            "block": "1111d60b-0329-42f9-b3c8-a6c4a1dacb15",
            "port": "out"
          },
          "target": {
            "block": "48d78d80-f30b-4181-b743-f202982bfb44",
            "port": "i_clk"
          },
          "vertices": [
            {
        ...
        {
          "source": {
            "block": "7d1409f4-62e0-4660-9abf-e72268c05744",
        ...
        {
          "source": {
            "block": "59689380-b6ee-4dae-a8e7-2ba96ab782ff",
            "port": "out"
          },
          "target": {
            "block": "7d1409f4-62e0-4660-9abf-e72268c05744",
        ...
        },
        {
          ...
          "target": {
            "block": "a0876153-1c32-4484-b507-79b97128f7fb",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "d2bfe48c-792f-4fba-9ddd-930c19af65e1",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "86657aff-af94-4d1b-a028-2be7ae639e41",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "b5ccfd48-59dc-46af-aa4b-963e2525d735",
            "port": "out"
          },
          "target": {
            "block": "48d78d80-f30b-4181-b743-f202982bfb44",
        ...
        {
          "source": {
            "block": "8ebea4f5-657d-40d2-ab8a-80c5cc4866dd",
            "port": "out"
          },
          "target": {
            "block": "48d78d80-f30b-4181-b743-f202982bfb44",
        ...
        {
          "source": {
            "block": "2da9cb5c-d663-4c46-9619-bd2ce3f9dfab",
